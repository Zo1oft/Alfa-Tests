# Проект по автоматизации тестирования alfabank.ru
<a href="https://alfabank.ru//"><img width="40%" title="Alfa" src="images/logo/alfa.png"></a>
...
- Проверка работы страницы оформления кредитной карты (c PageObjects)
- Проверка наличия Title на странице (работоспособности сайта)
- Проверка наличия ошибок в консоли

## :point_up_2: Сборка в Jenkins
### <a target="_blank" href="https://jenkins.autotests.cloud/job/Zoloft-Zenit-Tests/">Сборка в Jenkins</a>
<p align="center">
